...
execute as @a[scores={JoinData=0}] if score GameStarted JoinData matches 0 run function uhc:player_join
execute as @a[scores={JoinData=0}] if score GameStarted JoinData matches 1 run function uhc:spectator_join
