...
# Welcome message
execute as @a[scores={Joindata=0}] run function uhc:src/welcome
...
execute as @a[scores={JoinData=0}] if score GameStarted JoinData matches 1 run function uhc:src/spectator_join
